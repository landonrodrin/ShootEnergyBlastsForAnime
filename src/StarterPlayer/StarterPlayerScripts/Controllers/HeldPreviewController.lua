...
local Configurations = ReplicatedStorage.Configurations.Modules
local GameConfigurations = require(Configurations:WaitForChild("GameConfigurations"))
local AnimeConfigurations = require(Configurations:WaitForChild("AnimeConfigurations"))
local AreasConfigurations = require(Configurations:WaitForChild("AreasConfigurations"))
local MutationsConfigurations = require(Configurations:WaitForChild("MutationsConfigurations"))
local RebirthsConfigurations = require(Configurations:WaitForChild("RebirthsConfigurations"))
